...
public class Ejemplo06 {
    ...
    public static void main(String[] args) {
        ...
        // true 
        // while (bandera) {
        while(bandera==true){ // bandera es true trus==true | false== true f
            System.out.println("Ingrese calificación");//23 //15
            calificacion = entrada.nextDouble();

            if (calificacion > 20) { //23 > 20 v  | 15> 10 f
                calificacion = 20;    // 20
            }
            ...
            if (temporal == -1) { //0 == -1 | flaso  | -1==-1 verdadero
                bandera = false; // falso
            }
        }
